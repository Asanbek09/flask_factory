...
def add_admin():
    if request.method == 'POST':
        ...
        admin = Admin(id=int(request.form['id']), firstname=request.form['firstname'], middlename=request.form['middlename'], lastname=request.form['lastname'], email=request.form['email'], mobile=request.form['mobile'])
